const bodyElement = document.getElementById('wrapper'); //оболочка, id body
const unit = document.getElementById('unit'); //кружочек
unit.style.backgroundColor = Math.random() < 0.5 ? 'red' : 'green'; //цвет кружочка
